...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.pushButton_submit_2 = QtWidgets.QPushButton(Dialog)
        self.pushButton_submit_2.setObjectName("pushButton_submit_2")
        self.verticalLayout.addWidget(self.pushButton_submit_2)
        self.pushButton_revert_2 = QtWidgets.QPushButton(Dialog)
        self.pushButton_revert_2.setObjectName("pushButton_revert_2")
        self.verticalLayout.addWidget(self.pushButton_revert_2)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.pushButton_submit_2.setText(_translate("Dialog", "添加一行"))
        self.pushButton_revert_2.setText(_translate("Dialog", "删除选中行"))
