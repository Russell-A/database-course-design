...
# Form implementation generated from reading ui file 'change_plane_type.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.label_airplane_type = QtWidgets.QLabel(Dialog)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.label_airplane_type.sizePolicy().hasHeightForWidth())
        self.label_airplane_type.setSizePolicy(sizePolicy)
        self.label_airplane_type.setAcceptDrops(False)
        self.label_airplane_type.setAlignment(QtCore.Qt.AlignCenter)
        self.label_airplane_type.setObjectName("label_airplane_type")
        self.horizontalLayout_3.addWidget(self.label_airplane_type)
        self.lineEdit_airplane_type = QtWidgets.QLineEdit(Dialog)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.lineEdit_airplane_type.sizePolicy().hasHeightForWidth())
        self.lineEdit_airplane_type.setSizePolicy(sizePolicy)
        self.lineEdit_airplane_type.setObjectName("lineEdit_airplane_type")
        self.horizontalLayout_3.addWidget(self.lineEdit_airplane_type)
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "修改飞机机型"))
        self.label_airplane_type.setText(_translate("Dialog", "飞机机型："))
        self.label_empty.setText(_translate("Dialog", "（为空则查询全部飞机机型信息）"))
    ...
    def search(self):
        plane_type = self.lineEdit_airplane_type.text()  # 设置飞机型号
        self.model = QtSql.QSqlTableModel()
        self.model.setEditStrategy(QtSql.QSqlTableModel.OnManualSubmit)
        self.tableView_search.setModel(self.model)  # 绑定table
        self.model.setTable("飞机表")
        ...
        if plane_type == '':
            ...
            self.model.setFilter("机型 = '%s' " % (plane_type))
        ...
        if self.model.rowCount() == 0:
            QtWidgets.QMessageBox.information(self, "提示", "未找到符合条件的机型，请重试。", QtWidgets.QMessageBox.Ok)
            self.pushButton_submit.setEnabled(False)
            self.pushButton_revert.setEnabled(False)
        else:
            self.tableView_search.horizontalHeader().setSectionResizeMode(QtWidgets.QHeaderView.ResizeToContents)
